...
<body id="body">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="#">Sosial<span class="sr-only">(current)</span></a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container bg-light mt-5 p-4">
      ...
      <form class="mt-3">
        ...
        <div class="form-group font-weight-bold">
          <label for="exampleFormControlTextarea1">Hubungan Dengan Teman</label>
          <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
        <div class="form-group font-weight-bold">
          <label for="exampleFormControlTextarea1">Peran Dalam Kelompok</label>
          <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
