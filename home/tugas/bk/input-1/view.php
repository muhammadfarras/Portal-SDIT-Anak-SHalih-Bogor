      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#">Prestasi Akademik<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
    ...
    <div class="container bg-light mt-5 mb-5 p-4">
      ...
      <form class="mt-3" action="insert/" method="post">
        <div class="form-group font-weight-bold mb-5">
          <label for="exampleFormControlTextarea1" class="h4">Prestasi Akademik</label>
          <p class="text-muted">Dapat dijelaskan melalui narasi dan angka berdasarkan pretasi akademik di tiap semester</p>
          <textarea name="prestasi" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
          
          <!--Ini history terakhir pencatatan -->
          <?php
          $kognitif = getInformasiBk ($biodata['nis'],2,0);
