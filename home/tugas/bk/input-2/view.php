      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#">Bakat & Minat<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
    ...
    <div class="container bg-light mt-5 mb-5 p-4">
      ...
      <form class="mt-3" action="insert/" method="post">
        <div class="form-group font-weight-bold mb-5">
          <label for="bakatdanminat" class="h4">Bakat & Minat</label>
          <p class="text-muted">Dapat dijelaskan melalui narasi berdasarkan observasi dan hasil kuesioner</p>
          <textarea name="bakatdanminat" class="form-control" id="bakatdanminat" rows="3"></textarea>
          
          <!--Ini history terakhir pencatatan -->
          <?php
          $kognitif = getInformasiBk ($biodata['nis'],3,0);
