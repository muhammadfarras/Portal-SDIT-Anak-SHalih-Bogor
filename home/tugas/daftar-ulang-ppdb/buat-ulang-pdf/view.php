  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div id="modal-body" class="modal-body">
        <form autocomplete="off">
          <div class="form-group">
            ...
            <input type="text" id="NoPeserta" class="form-control" disabled>
          ...
          <div class="form-group">
            ...
            <input type="text" id="NamaPanggilan" class="form-control" disabled>
      ...
      <div class="modal-footer">
        ...
        <button id="modalBtn" type="button" class="btn btn-primary">Print dan Kirim Email Ulang Email</button>
      </div>
    </div>
  </div>
</div>
