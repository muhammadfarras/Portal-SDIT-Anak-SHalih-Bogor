  ...
  public function isFindFromDb(){
    $query = "SELECT * FROM ppdb_peserta_sementara WHERE nama LIKE '%$this->findName%' LIMIT 7";
     ...
     public function showFind(){
       $query = "SELECT * FROM ppdb_peserta_sementara WHERE nama LIKE '%$this->findName%' AND sudah_daftar = 1 LIMIT 7";
      ...
      public function showFetchAssocPeserta (){
        $query = "SELECT * FROM ppdb_peserta WHERE nama_panjang = '$this->findName'";
