...
<head>
    ...
    <title>Rekam Prilaku Siswa</title>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="#">Rekam Prilaku SDIT Anak Shalih Bogor</a>
          </li>
        </ul>
      </div>
    </nav>
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Lihat Rekam Prilaku Siswa</h5>
           <a href="#" class=""><small class="text-muted"><img class="card-img-top img-fluid w-25 float-left mr-2" src="img/search.png" alt="Card image cap"></small>
          <p class="card-text">
            Mencari rekam catatan siswa selama bersekolah di SDTI Anak Shalih Bogor.
          </p>
          </a>
        </div>
      </div>
