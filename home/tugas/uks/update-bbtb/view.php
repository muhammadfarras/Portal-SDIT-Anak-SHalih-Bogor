...
<body id="body">
  ...
  <h2 class="judul">Catat Tinggi Berat Badan Siswa</h2>
  <div class="container">
    <table class="biodata">
      <tr>
    ...
    <form action="update/" method="post">
      ...
      <div class="form-group">
        ...
        <input name="tinggi" type="number" class="form-control" id="TinggiBadan" placeholder="">
      </div>
      <div class="form-group">
        <label for="BeratBadan">Berat Badan</label>
        <input name="berat" type="number" class="form-control" id="BeratBadan" placeholder="">
      </div>
      
      <button name="catat" value="catat" type="submit" class="btn btn-success">Catat</button>
    </form> 
  </div>
  <script>
