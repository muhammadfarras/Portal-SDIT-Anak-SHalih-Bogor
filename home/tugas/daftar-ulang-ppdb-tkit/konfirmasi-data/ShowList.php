...
class FindDb {
  ...
  public function isFindFromDb(){
    $query = "SELECT * FROM ppdb_peserta_sementara WHERE nama LIKE '%$this->findName%' AND groupId = 'TKIT-AE' LIMIT 7";
     ...
     public function showFind(){
       $query = "SELECT * FROM ppdb_peserta_sementara WHERE nama LIKE '%$this->findName%' AND groupId = 'TKIT-AE' AND sudah_daftar = 0 LIMIT 7";
